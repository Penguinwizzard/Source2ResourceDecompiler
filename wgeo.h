...
typedef struct {
#endif
	uint32_t magic; // Woah, someone knows file format design basics in the
	                // ARTS dev scene? WAOW!
...
typedef struct { // Come on Riot, why didn't you make this fixed-size? it would
	         // save so much parsing time!
